...
nets = dict(
    ...
    namecoin_testnet=math.Object(
	 ...
	 templecoin=math.Object(
        ...
        SUBSIDY_FUNC=lambda height: 1*100000000 >> (height + 1)//325000,
        POW_FUNC=lambda data: pack.IntType(256).unpack(__import__('ltc_scrypt').getPoWHash(data)),
        BLOCK_PERIOD=150, # s
        SYMBOL='TPC',
        CONF_FILE_FUNC=lambda: os.path.join(os.path.join(os.environ['APPDATA'], 'Litecoin') if platform.system() == 'Windows' else os.path.expanduser('~/Library/Application Support/Litecoin/') if platform.system() == 'Darwin' else os.path.expanduser('~/.litecoin'), 'litecoin.conf'),
        BLOCK_EXPLORER_URL_PREFIX='http://explorer.templecoin.com/block/',
        ADDRESS_EXPLORER_URL_PREFIX='http://explorer.templecoin.com/address/',
        TX_EXPLORER_URL_PREFIX='http://explorer.templecoin.com/tx/',
